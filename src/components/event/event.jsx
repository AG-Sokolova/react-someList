...
const Event = () => {
    ...
    return (
        <form className="board__form">
            <h2 className="board__title">{id === undefined ? `Добавление события`:`Редактирование события`}</h2>
            ...
            <div className="btns">
                <button type="submit" className="btn-submit">{id === undefined ? `Добавить`:`Сохранить`}</button>
